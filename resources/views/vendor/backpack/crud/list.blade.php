  ...
  <div class="row">
    ...
    <div class="{{ $crud->getListContentClass() }}">
      <div class="card">
        ...
        <div class="overflow-hidden card-body table-responsive p-0">

        <table id="crudTable" class="table table-bordered table-hover dataTable">
            <thead>
              <tr>
                {{-- Table columns --}}
...
@section('after_styles')
  ...
  <link rel="stylesheet" href="{{ asset('vendor/admin/') }}/plugins/datatables/dataTables.bootstrap4.css">
