...
<div class="row mb-2">
        ...
        <small>{!! $crud->getSubheading() ?? trans('backpack::crud.reorder').' '.$crud->entity_name_plural !!}.</small></h1>
          </div>
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">{{ trans('backpack::crud.reorder') }}</li>
            </ol>
          </div>
        </div>
    ...
    <div class="col-md-8 offset-md-2">
        ...
        <div class="card">
            <div class="card-header">
                <h3 class="card-title">{!! $crud->getSubheading() ?? trans('backpack::crud.reorder').' '.$crud->entity_name !!}</h3>
            </div>
            <div class="card-body">
                <div class="col-md-12">
