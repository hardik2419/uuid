  <!-- DATA TABLES SCRIPT -->
<script src="{{ asset('vendor/admin/') }}/plugins/datatables/jquery.dataTables.js"></script>
<script src="{{ asset('vendor/admin/') }}/plugins/datatables/dataTables.bootstrap4.js"></script>
  <script src="{{ asset('vendor/admin/') }}/plugins/datatables/extensions/Responsive/js/dataTables.responsive.min.js"></script>
  <script src="{{ asset('vendor/admin/') }}/plugins/datatables/extensions/FixedHeader/js/dataTables.fixedHeader.min.js"></script>
